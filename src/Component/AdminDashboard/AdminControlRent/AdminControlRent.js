...
import './AdminControlRent.css';


const AdminControlRent = () => {
    const [signInUser, setSignInUser] = useContext(UserContext);
    const [serviceList, setServiceList] = useState([])


    useEffect(() => {
        fetch(`http://localhost:5000/rent/${signInUser.email}`)
            .then(res => res.json())
            ...
            <div className="row">
                ...
                <div className="col-md-9">
                    <nav className="navbar mr-auto d-flex justify-content-between">
                        ...
                        <p className="customerName">{signInUser.displayName}</p>
                    </nav>
...
export default AdminControlRent;