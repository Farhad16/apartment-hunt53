...
const Sidebar = () => {
    ...
    return (
        <aside className="sidebar d-flex flex-column justify-content-between py-2 px-4">
            ...
            <div>
                <Link to="/" className="logout ml-3" onClick={() => { setSignInUser({}); sessionStorage.clear() }}><FontAwesomeIcon icon={faSignOutAlt} /> <span className="logout-text">Logout</span></Link>
            </div>
        </aside>
    );
};
